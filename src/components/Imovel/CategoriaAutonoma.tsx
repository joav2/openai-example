...
const prompt = `Extraia as principais categorias dos feedbacks de clientes da empresa listados abaixo.`;

export default function CategorizacaoAutonoma() {
  ...
  const onSearch = async () => {
    setData("");
    setLoading(true);
    fetch("/api/imovel/categorizacao-autonoma", {
      method: "POST",
      body: pergunta,
    })
  ...
  return (
    <>
      ...
      >
        <Card title="Categorização autônoma imóveis" style={{ padding: "1rem" }}>
