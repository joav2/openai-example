...
const prompt = `Monte um plano de ação detalhado para resolver essa situação.`;
...
export default function PlanoAcao() {
  ...
  return (
    <>
      ...
      >
        <Card title="Plano de ação imóveis" style={{ padding: "1rem" }}>
