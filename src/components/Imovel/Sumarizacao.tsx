...
const prompt = `Faça um resumo dos feedbacks de clientes da empresa listados abaixo.`;

export default function Sumarizacao() {
  ...
  return (
    <>
      ...
      >
        <Card title="Sumarização imóveis" style={{ padding: "1rem" }}>
